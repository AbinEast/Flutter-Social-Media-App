        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 5),
              Text(likeCount[index].toString(), style: TextStyle(color: _textColor)),
              SizedBox(width: 20),
              GestureDetector(
                onTap: () {
                  Navigator.push(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  _drawerItem(Icons.favorite, "Welcome", onTap: () {
                    Navigator.pop(context);
                    Navigator.push(
                      context,
                  ...
                  _drawerItem(Icons.layers, "Pages", onTap: () {
                    Navigator.pop(context);
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Pages menu clicked'),
                        backgroundColor: Colors.orange,
                        duration: Duration(seconds: 1),
                      ),
                    );
                  }),
                  _drawerItem(Icons.widgets_outlined, "Components", onTap: () {
                    Navigator.pop(context);
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Components menu clicked'),
                        backgroundColor: Colors.orange,
                        duration: Duration(seconds: 1),
                      ),
                    );
                  ...
                  _drawerItem(Icons.person_outline, "Profile", onTap: () {
                    Navigator.pop(context);
                    setState(() {
                      _selectedIndex = 3;
                    });
                  }),
                  _drawerItem(Icons.chat, "Chat", badge: 5, onTap: () {
                    Navigator.pop(context);
                    setState(() {
                      _selectedIndex = 2;
                    });
